    ...
    <div style={{ position: 'relative', display: 'inline-block', ...style }}>
      <button
        ...
        style={{
          ...
          border: `1px solid ${open ? 'color-mix(in srgb, var(--color-accent) 60%, transparent)' : 'var(--border)'}`,
          boxShadow: open ? '0 0 0 3px color-mix(in srgb, var(--color-accent) 14%, transparent)' : 'none',
          color: 'var(--text)',
              ...
              <div key={opt.value || `__${i}`}>
                ...
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 'var(--radius-md)',
                    cursor: 'pointer',
                    background: isHigh ? 'color-mix(in srgb, var(--color-accent) 14%, transparent)' : isSelected ? 'color-mix(in srgb, var(--color-text) 7%, transparent)' : 'transparent',
                  ...
                  {opt.icon !== undefined && (
                    <div
                      style={{
                        ...
                        border: `1px solid ${opt.accent ? `color-mix(in oklab, ${opt.accent} 45%, transparent)` : 'color-mix(in srgb, var(--color-text) 14%, transparent)'}`,
                      }}
                    >
                      {opt.icon && (

...
export const BOSS_WING: Record<string, string> = {
  ...
  // Former strikes, folded into raids in-game — grouped by the expansion /
  // Living World release they belong to rather than each map on its own.
  'Legendary Icebrood Construct': 'Icebrood Saga',
  'The Voice and the Claw': 'Icebrood Saga',
  'Fraenir of Jormag': 'Icebrood Saga',
  Boneskinner: 'Icebrood Saga',
  'Whisper of Jormag': 'Icebrood Saga',
  'Ancient Forgeman': 'Icebrood Saga',
  'Minister of Morale': 'Icebrood Saga',
  'Mai Trin': 'End of Dragons',
  Ankka: 'End of Dragons',
  'Minister Li': 'End of Dragons',
  'The Dragonvoid': 'End of Dragons',
  Dagda: 'Secrets of the Obscure',
  Cerus: 'Secrets of the Obscure',
